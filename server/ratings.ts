...
import { eventCustomers, events, ratings, users } from '@/schema/schema';
...
export async function sendFeedback(prevState: any, formData: FormData) {
    ...
    try {
        ...
        const queryEventCustomers = await db.select({
            eventUuid: eventCustomers.eventUuid,
        })
            .from(eventCustomers)
            .where(eq(eventCustomers.ticketToken, rateData.ticket_token));

        const queryEventData = await db.select({
            eventName: events.eventName,
            userUuid: events.userUuid,
        })
            .from(events)
            .where(eq(events.uuid, queryEventCustomers[0].eventUuid));

        const queryOrganizer = await db.select({
            email: users.email,
            firstName: users.firstname,
            lastName: users.lastname,
        })
            .from(users)
            .where(eq(users.uuid, queryEventData[0].userUuid));
        ...
        let info = await transporter.sendMail({
            ...
            to: queryOrganizer[0].email,
            subject: "Някой оцени твоето събитие",
            ...
            <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#333333">Някой оцени '+queryEventData[0].eventName+'</h1> </td></tr><tr><td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><img class="adapt-img" src="https://ecgujso.stripocdn.email/content/guids/CABINET_b297a3f42cdd825f6211aa1ebcaf0723/images/82701618311893051.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="260"></td></tr> <tr>\
            <td align="center" class="es-m-p0r es-m-p0l" style="Margin:0;padding-top:5px;padding-bottom:5px;padding-left:40px;padding-right:40px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">Здравейте '+queryOrganizer[0].firstName +' '+queryOrganizer[0].lastName+'! Някой оцени твоето събитие '+queryEventData[0].eventName+' с '+rateData.rating+' звезди! Обратна връзка: <br>'+rateData.feedback+'</p>\
             <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, \'helvetica neue\', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px"></p></td></tr> <tr>\
            <td align="center" style="padding:0;Margin:0;padding-top:20px;padding-bottom:20px"></td></tr></table></td></tr></table></td></tr></table></td></tr></table> <table cellpadding="0" cellspacing="0" class="es-content" align="center" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%"><tr><td align="center" style="padding:0;Margin:0"><table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px"><tr><td align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px"><table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr>\
            ...
            //html: 'Някой оцени твоето събитие '+queryEventData[0].eventName+' с '+rateData.rating+' звезди! Обратна връзка: <br>'+rateData.feedback+',
        });
        //redirect('/my-tickets')
